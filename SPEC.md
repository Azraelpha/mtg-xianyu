...
HTTP 404 responses use an explicit `{"_not_found": true}` data sentinel in the
same envelope and TTL, preventing repeated misses while allowing newly added
sbwsz records to become visible after expiry.
